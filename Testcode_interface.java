interface Testcode_interface
{
 public int additiontest(String s, String f, String language, String ofile);
 public int sumchecktest(String s, String f, String language, String ofile);
